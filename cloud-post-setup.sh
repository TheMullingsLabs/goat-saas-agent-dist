#!/bin/bash
# goat-saas-agent Cloud Post-Setup
...
echo ""
echo "============================================"
echo "  goat-saas-agent Post-Setup"
echo "============================================"
echo ""
...
echo "    5. cd <repo> && goat-saas-agent run --auto-approve --skip-codex --analysis-model claude-sonnet-4-6"
echo ""
echo "  To skip database setup (already done as root):"
echo "    goat-saas-agent run --from-step claude-code-phase-1 --auto-approve --skip-codex --analysis-model claude-sonnet-4-6"
echo "============================================"
